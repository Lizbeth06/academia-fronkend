...
import { Niveleducacion } from "../../../../core/model/niveleducacion";
import { Oficina } from "../../../../core/model/oficina";
...
import { NiveleducacionService } from "../../../../core/services/niveleducacion.service";
...
export class TrabajadorFormComponent {
  ...
  ngOnInit(): void {
    ...
    this.id &&
      this.trabajadorService.findById(this.id).subscribe((data) => {
