...
import { Trabajador } from "../../../../core/model/trabajador";
  ...
  ngOnInit(): void {
    ...
    if (this.usuario && this.usuario.idUsuario) {
      this.form.patchValue({
        numDocumento: this.usuario.persona?.numDocumento,
        nombres: this.usuario.persona?.nombres,
        apaterno: this.usuario.persona?.apaterno,
        amaterno: this.usuario.persona?.amaterno,
        genero: this.usuario.persona?.genero,
        isActive: this.usuario.estado,
        username: this.usuario.username,
        password: this.usuario.password,
        urlFoto: this.usuario.persona?.urlFoto,
      });
    }
  }
