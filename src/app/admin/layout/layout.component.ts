import { AfterViewInit, ChangeDetectorRef, Component, inject, OnDestroy, OnInit, PLATFORM_ID, Renderer2, DOCUMENT } from "@angular/core";
...
@Component({
  selector: "app-layout",
  imports: [RouterModule, MaterialModule, RouterOutlet, ItemMenuOptionComponent, MatIconModule, TitleCasePipe, NgClass],
...
export class LayoutComponent implements OnInit, OnDestroy {
  ...
  private procesarMenu(menus: Menu[]): void {
    ...
    this.menuGrupos = Array.from(gruposMap.values()).sort((a, b) => a.grupo.idMenugrupo - b.grupo.idMenugrupo);
  }
